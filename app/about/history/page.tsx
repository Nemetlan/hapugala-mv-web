            ...
            <div className="space-y-24">
              ...
              >
                ...
                <p className="text-white/80 leading-relaxed mb-8 text-center">
                  The leadership of <strong>K.P.K. Wipul Milinda Padikkorale</strong> and current principal <strong>Mr. Dinesh Hettiarachchi</strong> has focused on holistic development. From all-island musical honors to high academic pass rates, the school continues to shine.
                </p>
